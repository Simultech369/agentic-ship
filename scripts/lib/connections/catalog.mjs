...
const PROBE_TYPES = new Set(["any_file_exists", "cloudflare_blueprint", "command_succeeds", "env_file_key", "file_contains", "file_exists", "home_file_exists", "mcp_server", "postmark_blueprint"]);
